...
def get_candidate_profile(userid):
    ...
    try:
        ...
        _candidate = {'id': _profile.id, 'user_id': userid, 'fname': user.first_name,
                      ...
                      'education': _profile.education, 'experience': _profile.experience, 'contact':_profile.contact,
...
def get_answered(userid, qp_id,tid):
    ...
    for key, value in mcq_ans.items():
        ...
        details[key] = {'type': question.qtype, "description": question.description,
                        "selected":value["answer"], "options":options,
